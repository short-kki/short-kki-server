...
-- 파일: 공식 로고 이미지
-- =============================================
INSERT INTO file_metadata (id, object_key, original_name, extension, size, target_type, target_id, uploader_type, uploader_id, upload_status, visibility, public_url, created_at, updated_at)
VALUES (1, 'public/assets/logo.png','profile.png','png',491363,'MEMBER_PROFILE_IMG',NULL,'SYSTEM',NULL,'UPLOADED','PUBLIC','https://d36jasu56jneaq.cloudfront.net/assets/logo.png',NOW(6),NOW(6));

-- =============================================
-- 멤버
-- =============================================
INSERT INTO `member` (id, email, name, role, oauth_provider, oauth_id, profile_img_file_id, created_at, updated_at)
VALUES (1, 'shortkki-dev1@gmail.com', '숏끼', 'USER', 'GOOGLE', 'SYSTEM', 1, NOW(6), NOW(6));
