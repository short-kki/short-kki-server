...
public record RecipeCreateRequest(
        ...
        @Valid SourceInfo sourceInfo, // nullable: 수동 입력 시 없음
    ...
    public record StepInfo(
            @NotNull(message = "순서 번호는 필수입니다") @Positive Integer stepNumber,
    ...
    /**
     * Recipe 엔티티로 변환
     * sourceInfo 유무에 따라 수동/링크 가져오기 분기
     */
