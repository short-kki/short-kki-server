...
public record RecipeCreateRequest(
    ...
    public record BasicInfo(
            ...
            @NotNull(message = "1인분 기준 양은 필수입니다")
            @Positive(message = "1인분 기준 양은 양수여야 합니다") Integer servingSize,

            @NotNull(message = "조리 시간은 필수입니다")
            @Positive(message = "조리 시간은 양수여야 합니다") Integer cookingTime) {

    }

    // -- 카테고리 정보 --
    public record CategoryInfo(
            @NotNull(message = "요리 종류는 필수입니다")
